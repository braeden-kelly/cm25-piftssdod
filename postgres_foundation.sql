 ...
 * with a SERIAL column, which is still possible, but no longer recommended
 * if the true intent is to have an identity column. Under the covers you'll 
 * see the same thing (a sequence attached to the column).
 * 
 ...
 * from a space or planning memory perspecitve. Constraints can be used to limit
 * text input. 
 * 
...
INSERT INTO sensor_reading
	...
	FROM 
		 ...
		 generate_series('2025-01-14','2025-01-15','10 second'::interval) AS g2(i);
