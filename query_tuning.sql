 ...
 * cleanup
 */
DROP INDEX rental_inventory_id_idx_nondedup;
DROP INDEX rental_rental_period_upper;
DROP INDEX rental_rental_period_upper_null;
DROP INDEX rental_store_id_upper_rental_null_idx;
DROP INDEX film_film_id_incl;
